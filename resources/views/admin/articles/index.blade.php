<x-admin-layout title="Manage Articles">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr>
                        ...
                        <td class="py-2 space-x-2 flex items-start justify-start">
                            <a href="{{ route('show.article', $article) }}" class="text-blue-500 hover:text-blue-600 transition-transform duration-200 hover:scale-110 inline-block" title="View Article">
