            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <section class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
                    <div class="space-y-1">
                        ...
                        <input type="text" name="title" id="title" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none" placeholder="Enter article title" required value="{{ old('title') }}">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="slug" id="slug" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none" placeholder="auto-generated" value="{{ old('slug') }}">
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none" placeholder="Short summary...">{{ old('excerpt') }}</textarea>
                ...
                <section class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="meta_title" id="meta_title" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none" value="{{ old('meta_title') }}">
                    </div>

                    <div class="space-y-1">
                        <label for="meta_description" class="block text-sm font-medium text-slate-700">Meta Description</label>
                        <textarea name="meta_description" id="meta_description" rows="2" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none">{{ old('meta_description') }}</textarea>
                    </div>

                    <div class="space-y-1">
                        <label for="meta_keywords" class="block text-sm font-medium text-slate-700">Meta Keywords</label>
                        <input type="text" name="meta_keywords" id="meta_keywords" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none" placeholder="comma, separated, keywords" value="{{ old('meta_keywords') }}">
                    </div>

                    <div class="space-y-1">
                        <label for="canonical_url" class="block text-sm font-medium text-slate-700">Canonical URL</label>
                        <input type="url" name="canonical_url" id="canonical_url" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none" value="{{ old('canonical_url') }}">
                    </div>
                </section>
            </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <section class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm space-y-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="datetime-local" name="published_at" id="published_at" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none" value="{{ old('published_at') }}">
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="max-h-40 overflow-y-auto border border-slate-300 rounded-lg p-2 bg-white space-y-2">
                            ...
                            <label class="flex items-center gap-2 text-sm text-slate-700 cursor-pointer">
                                <input type="checkbox" name="tags[]" value="{{ $tag->id }}" class="rounded text-brand-500 focus:ring-brand-500" {{ in_array($tag->id, old('tags', [])) ? 'checked' : '' }}>
                                {{ $tag->title }}
                            </label>
                            @endforeach
                        </div>
                ...
                <section class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm space-y-4">
                    ...
                    <div class="space-y-1">
                        <input type="text" name="featured_image_url" id="featured_image_url" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none" value="{{ old('featured_image_url') }}" placeholder="https://example.com/image.jpg">
                ...
                <section class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm space-y-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="og_image_url" id="og_image_url" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-brand-500 focus:outline-none" placeholder="https://example.com/image.jpg" value="{{ old('og_image_url') }}">
